...
window.ELECTRONIC_PRODUCTS = {
    ...
    'cp-p3': {
        ...
        desc: '使用喇叭鎖孔安裝，無須額外開孔。<br>適合租屋族、房東、辦公室及其他一般房間門。<br>一般款：指紋、卡片、密碼、鑰匙解鎖。<br>遠端款：包含一般款全部功能，另有 APP 遠端設定、遠端解鎖、APP 解鎖通知、解鎖失敗通知、操作紀錄、低電量提醒、臨時密碼。<br>沒電時可使用機械鑰匙開鎖，也可使用 USB 應急供電後解鎖。<br>租屋族：無須額外開孔，方便退租時復原，出門不怕忘記帶鑰匙，提升安全性。<br>房東：方便租客管理，提升租屋品質。<br>保固一年。',
        features: [
            '使用喇叭鎖孔，無須額外開孔',
            '一般款：指紋 / 卡片 / 密碼 / 鑰匙',
